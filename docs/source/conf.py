...
project = "transit-chem"
copyright = "2018, Evan M Curtin"
...
latex_documents = [
    (master_doc, "transit_chem.tex", "transit-chem Documentation", "Evan M Curtin", "manual")
]
...
man_pages = [(master_doc, "transit_chem", "transit-chem Documentation", [author], 1)]
